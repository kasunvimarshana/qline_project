    ...
    public function up()
    {
        Schema::create('defect_categories', function (Blueprint $table) {
            ...
            */
            ...
            $table->string('defect_category_id_parent')->index()->nullable()->comment('comment');
            //$table->softDeletes();
        ...
        DB::statement('ALTER TABLE defect_categories MODIFY COLUMN id INTEGER NOT NULL UNIQUE AUTO_INCREMENT;');
    }
