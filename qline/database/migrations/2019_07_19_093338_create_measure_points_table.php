...
class CreateMeasurePointsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('measure_points', function (Blueprint $table) {
            /*
            ...
            */
            ...
            $table->string('measure_point_id_parent')->index()->nullable()->comment('comment');
            //$table->softDeletes();
        ...
        DB::statement('ALTER TABLE measure_points MODIFY COLUMN id INTEGER NOT NULL UNIQUE AUTO_INCREMENT;');
    }
    ...
    {
        Schema::dropIfExists('measure_points');
    }
}
