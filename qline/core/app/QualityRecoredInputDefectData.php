...
class QualityRecoredInputDefectData extends Model
{
    //
    ...
    protected $fillable = array('id', 'is_visible', 'is_active', 'time_create', 'code', 'count_data', 'company_id', 'strategic_business_unit_id', 'factory_id', 'line_id', 'customer_id', 'style_id', 'colour_id', 'export_id', 'user_id_create', 'ip_address', 'status_id');
