...
class ExportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = array(
            'code' => 'required|unique:exports,code'
        );
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $dataArray = array(
                    ...
                    'export_id_parent' => $request->input('export_id_parent')
                );

                $exportObject = Export::create( $dataArray );
                unset($dataArray);
    ...
    public function show(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $exportObject = $exportObject->where('id', '=', $request->input('id'))->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $exportObject = $exportObject->update( $dataArray );
                unset($dataArray);
                $data['export_object'] = $exportObject;
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                */
                ...
                // export_id_parent
                if( ($request->has('export_id_parent')) && ($request->filled('export_id_parent')) ){
                    $export_id_parent = $request->input('export_id_parent');
                    $query = $query->where('export_id_parent', '=', $export_id_parent);
                }
