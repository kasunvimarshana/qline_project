...
class InspectionStageController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $inspectionStageObject = $inspectionStageObject
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $inspectionStageObject = $inspectionStageObject->update( $dataArray );
                unset($dataArray);
                $data['inspection_stage_object'] = $inspectionStageObject;
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(InspectionStage $inspectionStage)
    {
        //
        $dataArray = array();
        $rules = array();
