...
class StandardSewingAuditController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $rules = array(
            'code' => 'required|unique:standard_sewing_audits,code'
        );
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $dataArray = array(
                    ...
                    'standard_sewing_audit_id_parent' => $request->input('standard_sewing_audit_id_parent'),
                ...
                $standardSewingAuditObject = StandardSewingAudit::create( $dataArray );
                unset($dataArray);
    ...
    public function show(Request $request)
    {
        ...
        // validate the info, create rules for the inputs
        $rules = array(
            'id' => 'required|exists:standard_sewing_audits,id'
        );
        // run the validation rules on the inputs from the form
        $validator = Validator::make(Input::all(), $rules);
        // if the validator fails, redirect back to the form
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardSewingAuditObject = $standardSewingAuditObject->where('id', '=', $request->input('id'))->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardSewingAuditObject = $standardSewingAuditObject->update( $dataArray );
                unset($dataArray);
                $data['standard_sewing_audit_object'] = $standardSewingAuditObject;
    ...
    public function destroy(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardSewingAuditObject = new StandardSewingAudit();
                $standardSewingAuditObject = $standardSewingAuditObject->where('id', '=', $request->input('id'))->first();
                $standardSewingAuditObject->delete();
    ...
    //other
    public function selectAllStandardSewingAudits(Request $request){
        //
        $dataArray = array();
        $rules = array();
        $date_today = Carbon::now();//->format('Y-m-d');
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardSewingAuditObject = new StandardSewingAudit();
                $query = $standardSewingAuditObject;
                /*
                ...
                */
                ...
                // standard_sewing_audit_id_parent
                if( ($request->has('standard_sewing_audit_id_parent')) && ($request->filled('standard_sewing_audit_id_parent')) ){
                    $standard_sewing_audit_id_parent = $request->input('standard_sewing_audit_id_parent');
                    $query = $query->where('standard_sewing_audit_id_parent', '=', $standard_sewing_audit_id_parent);
                }
