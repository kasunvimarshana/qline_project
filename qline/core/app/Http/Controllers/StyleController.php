...
class StyleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $styleObject = Style::create( $dataArray );
                unset($dataArray);
    ...
    public function show(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $styleObject = $styleObject->where('id', '=', $request->input('id'))->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $styleObject = $styleObject->update( $dataArray );
                unset($dataArray);
                $data['style_object'] = $styleObject;
    ...
    //other
    public function selectAllStyles(Request $request){
        //
        $dataArray = array();
        $rules = array();
        $date_today = Carbon::now();//->format('Y-m-d');
