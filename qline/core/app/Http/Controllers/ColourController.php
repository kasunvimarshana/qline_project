...
class ColourController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = array(
            'code' => 'required|unique:colours,code'
        );
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $colourObjet = Colour::create( $dataArray );
                unset($dataArray);
                $data['colour_object'] = $colourObjet;
    ...
    public function show(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $colourObject = $colourObject->where('id', '=', $request->input('id'))->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $colourObject = $colourObject->update( $dataArray );
                unset($dataArray);
                $data['colour_object'] = $colourObject;
