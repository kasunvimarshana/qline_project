...
class StandardDataAQLController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardDataAQLObject = StandardDataAQL::create( $dataArray );
                unset($dataArray);
                $data['standard_data_a_q_l_object'] = $standardDataAQLObject;
    ...
    public function show(Request $request)
    {
        ...
        // validate the info, create rules for the inputs
        $rules = array(
            'id' => 'required|exists:standard_data_a_q_l_s,id'
        );
        // run the validation rules on the inputs from the form
        $validator = Validator::make(Input::all(), $rules);
        // if the validator fails, redirect back to the form
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardDataAQLObject = new StandardDataAQL();
                $standardDataAQLObject = $standardDataAQLObject->where('id', '=', $request->input('id'))->first();
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                $standardDataAQLObject = $standardDataAQLObject->update( $dataArray );
                unset($dataArray);
                $data['standard_data_a_q_l_object'] = $standardDataAQLObject;
    ...
    //other
    public function selectAllStandardDataAQL(Request $request){
        //
        $dataArray = array();
        $rules = array();
        $date_today = Carbon::now();//->format('Y-m-d');
