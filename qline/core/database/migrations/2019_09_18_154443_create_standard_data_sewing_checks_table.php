...
class CreateStandardDataSewingChecksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('standard_data_sewing_checks', function (Blueprint $table) {
            /*
            ...
            */
            ...
            $table->string('standard_sewing_check_id')->index()->nullable()->comment('comment');
        });
        
        Schema::table('standard_data_sewing_checks', function($table) {
            //$table->primary(array('id'), ('pk'.time().Str::uuid()->toString()));
            //$table->unique(array('id'), ('unique'.time().Str::uuid()->toString()));
            //$table->index(array('id'), ('index'.time().Str::uuid()->toString()));
            //$table->foreign('status_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('statuses')->onUpdate('cascade');
            $table->foreign('standard_sewing_check_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('standard_sewing_checks')->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('standard_data_sewing_checks');
    }
}
