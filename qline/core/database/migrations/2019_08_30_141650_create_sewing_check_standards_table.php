...
class CreateSewingCheckStandardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sewing_check_standards', function (Blueprint $table) {
            /*
            ...
            */
            ...
            $table->string('sewing_check_standard_id_parent')->index()->nullable()->comment('comment');
        ...
        DB::statement('ALTER TABLE sewing_check_standards MODIFY COLUMN id INTEGER NOT NULL UNIQUE AUTO_INCREMENT;');
    }
    ...
    {
        Schema::dropIfExists('sewing_check_standards');
    }
}
