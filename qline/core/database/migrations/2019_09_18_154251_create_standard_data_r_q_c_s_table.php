...
class CreateStandardDataRQCSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('standard_data_r_q_c_s', function (Blueprint $table) {
            /*
        ...
        Schema::table('standard_data_r_q_c_s', function($table) {
            //$table->primary(array('id'), ('pk'.time().Str::uuid()->toString()));
            //$table->unique(array('id'), ('unique'.time().Str::uuid()->toString()));
            //$table->index(array('id'), ('index'.time().Str::uuid()->toString()));
            //$table->foreign('status_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('statuses')->onUpdate('cascade');
            $table->foreign('standard_r_q_c_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('standard_r_q_c_s')->onUpdate('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('standard_data_r_q_c_s');
    }
}
