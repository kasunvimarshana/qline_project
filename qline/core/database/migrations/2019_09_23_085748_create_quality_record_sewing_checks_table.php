...
class CreateQualityRecordSewingChecksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quality_record_sewing_checks', function (Blueprint $table) {
            /*
        ...
        Schema::table('quality_record_sewing_checks', function($table) {
    ...
    {
        Schema::dropIfExists('quality_record_sewing_checks');
    }
}
