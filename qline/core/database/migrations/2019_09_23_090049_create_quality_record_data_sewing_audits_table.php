...
class CreateQualityRecordDataSewingAuditsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quality_record_data_sewing_audits', function (Blueprint $table) {
            /*
            ...
            */
            ...
            $table->unsignedBigInteger('quality_record_sewing_audit_id')->unsigned()->nullable()->comment('comment');//->index()
        ...
        Schema::table('quality_record_data_sewing_audits', function($table) {
            //$table->primary(array('id'), ('pk'.time().Str::uuid()->toString()));
            //$table->unique(array('id'), ('unique'.time().Str::uuid()->toString()));
            //$table->index(array('id'), ('index'.time().Str::uuid()->toString()));
            //$table->foreign('status_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('statuses')->onUpdate('cascade');
            $table->foreign('quality_record_sewing_audit_id', ('fk'.time().Str::uuid()->toString()))->references('id')->on('quality_record_sewing_audits')->onUpdate('cascade')->onDelete('cascade');
            ...
            $table->index(array('quality_record_sewing_audit_id'), ('index'.time().Str::uuid()->toString()));
    ...
    {
        Schema::dropIfExists('quality_record_data_sewing_audits');
    }
}
