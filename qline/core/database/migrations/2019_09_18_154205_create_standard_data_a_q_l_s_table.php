...
class CreateStandardDataAQLSTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('standard_data_a_q_l_s', function (Blueprint $table) {
            /*
        ...
        Schema::table('standard_data_a_q_l_s', function($table) {
    ...
    {
        Schema::dropIfExists('standard_data_a_q_l_s');
    }
}
