...
class CreateQualityRecordCuttingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quality_record_cuttings', function (Blueprint $table) {
            /*
        ...
        Schema::table('quality_record_cuttings', function($table) {
    ...
    {
        Schema::dropIfExists('quality_record_cuttings');
    }
}
