...
class CreateStandardSewingAuditsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('standard_sewing_audits', function (Blueprint $table) {
            /*
            ...
            */
            ...
            $table->string('standard_sewing_audit_id_parent')->index()->nullable()->comment('comment');
        ...
        Schema::table('standard_sewing_audits', function($table) {
    ...
    {
        Schema::dropIfExists('standard_sewing_audits');
    }
}
