                                    ...
                                    <div id="accordion2_1">
                                        ...
                                        <div class="card bg-danger">
                                            <div class="card-header" id="idCard2_1">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-default m-0 p-0 text-white" data-toggle="collapse" data-target="#idCollapse2_1" aria-expanded="true" aria-controls="idCollapse2_1">
                                                    <i class="fa fa-plus fa-fw"></i>
                                            ...
                                            <div id="idCollapse2_1" class="collapse hide" aria-labelledby="idCard2_1" data-parent="#idCollapse2_1">
                                                <div class="card-body">
                                                    <table class="table">
                                                        <tr>
                                                            <td class="p-0 m-0">
                                    ...
                                    <div id="accordion2_2">
                                        ...
                                        <div class="card bg-danger">
                                            <div class="card-header" id="idCard2_2">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-default m-0 p-0 text-white" data-toggle="collapse" data-target="#idCollapse2_2" aria-expanded="true" aria-controls="idCollapse2_2">
                                                    <i class="fa fa-plus fa-fw"></i>
                                            ...
                                            <div id="idCollapse2_2" class="collapse hide" aria-labelledby="idCard2_2" data-parent="#idCollapse2_2">
                                                <div class="card-body">
                                                    <table class="table">
                                                        <tr>
                                                            <td class="p-0 m-0">
                                    ...
                                    <div id="accordion2_4">
                                        ...
                                        <div class="card bg-danger">
                                            <div class="card-header" id="idCard2_4">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-default m-0 p-0 text-white" data-toggle="collapse" data-target="#idCollapse2_4" aria-expanded="true" aria-controls="idCollapse2_4">
                                                    <i class="fa fa-plus fa-fw"></i>
                                            ...
                                            <div id="idCollapse2_4" class="collapse hide" aria-labelledby="idCard2_4" data-parent="#idCollapse2_4">
                                                <div class="card-body">
                                                    <table class="table">
                                                        <tr>
                                                            <td class="p-0 m-0">
                                    ...
                                    <div id="accordion2_3">
                                        ...
                                        <div class="card bg-danger">
                                            <div class="card-header" id="idCard2_3">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-default m-0 p-0 text-white" data-toggle="collapse" data-target="#idCollapse2_3" aria-expanded="true" aria-controls="idCollapse2_3">
                                                    <i class="fa fa-plus fa-fw"></i>
                                            ...
                                            <div id="idCollapse2_3" class="collapse hide" aria-labelledby="idCard2_3" data-parent="#idCollapse2_3">
                                                <div class="card-body">
                                                    <table class="table">
                                                        <tr>
                                                            <td class="p-0 m-0">
