                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <form action="{!! route('home') !!}" method="POST" class="col col-sm-12 row" autocomplete="off" id="form1" enctype="multipart/form-data">
                                                ...
                                                <div class="col col-md-4">
                                                    ...
                                                    <!-- form-group -->
                                                    <div class="form-group row col-sm-12 m-1">
                                                        <label for="image_uri" class="col-lg-4 control-label col-form-label col-form-label-md text-justify font-weight-bold text-md-right">File</label>
                                                        <div class="col">
                                                            <!-- p class="form-control-static"></p -->
                                                            <div class="col">
                                                                <!-- class="file" -->
                                                                <input type="file" multiple="false" class="form-control form-control-md file" id="image_uri" name="image_uri" value="{{ old('image_uri') }}" data-preview-file-type="text"/>
                                                            </div>
                                                        </div>
                                                        <!-- span id="form-control" class="help-block"></span -->
                                                    </div>
